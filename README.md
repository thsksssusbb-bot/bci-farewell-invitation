...
<body>
        ...
        <div id="step2" class="step">
            ...
            <div class="invitation-content">
                ...
                <div class="details">
                    ...
                    <div class="detail-item"><div class="detail-icon">⏰</div><div><strong>Time:</strong> 6:00 PM onwards</div></div>
                    <div class="detail-item"><div class="detail-icon">📍</div><div><strong>Venue:</strong> BCI Campus Auditorium</div></div>
                </div>
        ...
        <div id="step3" class="step">
            ...
            <div class="invitation-content">
                ...
                <div class="footer">
                    ...
                    <p>- The Graduating Class of 2025</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        // Simple storage - responses will be saved in your browser's localStorage
        // For you to view responses, you'll need to check the browser console
        let teacherResponses = JSON.parse(localStorage.getItem('bciTeacherResponses')) || [];
        ...
        function proceedToInvitation() {
            ...
            const existingResponse = teacherResponses.find(t => t.name.toLowerCase() === name.toLowerCase());
            if (existingResponse) {
                // If already responded, go directly to thank you page
                currentTeacher.response = existingResponse.response;
                showThankYouPage();
            } else {
                // Show invitation
        ...
        function handleResponse(response) {
            ...
            const existingIndex = teacherResponses.findIndex(t => t.name.toLowerCase() === currentTeacher.name.toLowerCase());
            if (existingIndex !== -1) {
                teacherResponses[existingIndex].response = response;
            } else {
            ...
            localStorage.setItem('bciTeacherResponses', JSON.stringify(teacherResponses));
            
            // Log to console (for you to check)
            console.log('Teacher Responses:', teacherResponses);
        ...
        // Add admin function to view responses (only for you)
        function viewAllResponses() {
            console.log('All Teacher Responses:', teacherResponses);
            alert('Check the browser console (F12) to see all responses');
        }
        
        // Add a hidden way for you to view responses (press 'A' key three times)
        let adminKeyCount = 0;
